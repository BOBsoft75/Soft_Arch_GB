...
public class StartClass {
    public static void main(String[] args) {
        Sedan octavia = new Sedan("Skoda", "Octavia", Color.RED, "Sedan", 4, "Petrol", "Automatic", 1.4f, new Petrol());
        SUV touareg = new SUV("Volkswagen", "Touareg", Color.BLACK, "SUV", 4, "Diesel", "Automatic 4WD", 3.0f, new Diesel());
